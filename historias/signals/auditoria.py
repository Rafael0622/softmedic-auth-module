# historias/signals/auditoria.py
...
# Importación absoluta de los modelos de la app
from historias.models import HistoriaClinica, Diagnostico, Medicamento, Observacion, Cita
